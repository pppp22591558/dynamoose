...
Model.prototype.put = function(options, next) {
  ...
  function putItem() {
    model$.base.daxClient().put(item, function(err, k) {
      if(err) {
        deferred.reject(err);
      }
...
Model.get = function(NewModel, key, options, next) {
  ...
  function get () {
    ...
    newModel$.base.daxClient().get(getReq, function(err, data) {
      if(err) {
...
Model.update = function(NewModel, key, update, options, next) {
  ...
  function updateItem () {
    ...
    newModel$.base.daxClient().update(updateReq, function(err, data) {
      if(err) {
        debug('Error returned by updateItem', err);
        return deferred.reject(err);
      }
...
Model.prototype.delete = function(options, next) {
  ...
  function deleteItem() {
    ...
    model$.base.daxClient().delete(getDelete, function(err, data) {
      if(err) {
...
Model.batchGet = function(NewModel, keys, options, next) {
  ...
  function batchGet () {
    ...
    newModel$.base.daxClient().batchGet(batchReq, function(err, data) {
      if(err) {
...
function batchWriteItems (NewModel, batchRequests) {
  ...
  var batchList = batchRequests.map(function (batchReq) {
    ...
    newModel$.base.daxClient().batchWrite(batchReq, function(err, data) {
      if(err) {
