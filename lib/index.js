...
Dynamoose.prototype.dax = function (daxService) {
  this.daxService = daxService;
  debug('Setting DAX client');
};
...
Dynamoose.prototype.daxClient = function() {
  if (this.daxDocumentClient) {
    return this.daxDocumentClient;
  }
  if (this.daxService) {
    this.daxDocumentClient = new this.AWS.DynamoDB.DocumentClient({ service: this.daxService });
  } else {
    this.daxDocumentClient = this.documentClient();
  }
  return this.daxDocumentClient;
};
